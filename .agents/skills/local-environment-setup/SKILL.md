...
2. Create local configuration:
   ...
   openssl rand -hex 32
   ```
   Set `DATABASE_URL=postgresql://postgres:postgres@localhost:5432/supastarter`, paste the generated value into `BETTER_AUTH_SECRET`, and keep `VITE_SAAS_URL`, `VITE_MARKETING_URL`, and `VITE_DOCS_URL` at `3000`, `3001`, and `3002`. Leave provider values blank unless exercising that integration.
