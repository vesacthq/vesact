	...
	return (
		<div
			className={cn(
				...
				"shadow-xs relative overflow-hidden rounded-(--frame-panel-radius) border border-(--frame-panel-border-color) bg-(--frame-panel-bg) bg-clip-padding",
				// `fit` sizes the panel to its content; otherwise it grows to fill the frame.
				!fit && "grow",
				"before:inset-0 before:shadow-black/5 before:pointer-events-none before:absolute before:rounded-[calc(var(--frame-panel-radius)_-_1px)]",
				"dark:before:shadow-white/5 dark:bg-clip-border",
