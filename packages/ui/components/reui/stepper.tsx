...
function StepperIndicator({ children, className }: React.ComponentProps<"div">) {
	...
	return (
		<div
			...
			data-state={state}
			className={cn(
				"size-6 relative flex shrink-0 items-center justify-center overflow-hidden border-background bg-accent text-accent-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=completed]:bg-primary data-[state=completed]:text-primary-foreground",
...
function StepperSeparator({ className }: React.ComponentProps<"div">) {
	...
	return (
		<div
			...
			data-state={state}
			className={cn(
				"m-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 rounded-sm bg-muted group-data-[orientation=horizontal]/stepper-nav:flex-1",
				className,
			)}
		/>
	);
